...
public class ApplicationLightPreference extends Preference implements
    ...
    private String mapLengthValue(Integer time) {
        ...
        String[] time_names = mResources.getStringArray(R.array.notification_pulse_length_entries);
        String[] time_values = mResources.getStringArray(R.array.notification_pulse_length_values);
    ...
    private String mapSpeedValue(Integer time) {
        ...
        String[] time_names = mResources.getStringArray(R.array.notification_pulse_speed_entries);
        String[] time_values = mResources.getStringArray(R.array.notification_pulse_speed_values);
